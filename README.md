...
Проект демонстрирует архитектуру AI-ассистента с использованием LLM, RAG и инструментов (tools) для работы с пользовательскими данными. Ассистент умеет отвечать на вопросы о диабете, работать с дневником сахара и самочувствия и анализировать измерения.
